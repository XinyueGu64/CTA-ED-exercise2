...
```{r, eval = F}
tweets  <- readRDS(gzcon(url("https://github.com/cjbarrie/CTA-ED/blob/main/data/sentanalysis/newstweets.rds?raw=true")))1
...
```{r}
tweets_url <- "https://github.com/cjbarrie/CTA-ED/blob/main/data/sentanalysis/newstweets.rds?raw=true"
tmp <- tempfile(fileext = ".rds")
download.file(tweets_url, tmp, mode = "wb")
tweets <- readRDS(tmp)
